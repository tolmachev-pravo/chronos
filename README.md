...
* **Видно, откуда взялось предложение.** Клик по иконке источника раскрывает под строкой то, что
  Chronos о событии знает: текст комментария со ссылкой на него, переход статуса «откуда → куда»,
  организатора и место встречи.
...
У любой строки, кроме уже списанного, иконка источника раскрывает врезку с тем, что этот источник
о событии знал: комментарий, переход статуса, приглашение на встречу.
